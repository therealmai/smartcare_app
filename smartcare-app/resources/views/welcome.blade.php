...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   ...
   <div class="container-xl">  
     ...
     <div class="container-fluid">
         ...
         <div class="logo-image">
               <img src="../img/logo.jpg" width="100" height="300" class="img-fluid">
         </div>
         </a>
       ...
       <div class="collapse navbar-collapse nav justify-content-end" id="navbarNavDropdown">
         <ul class="nav">
           ...
           <li class="nav-item dropdown nav-head">
           ...
           <li class="nav-item">
             <a class="nav-link nav-head" href="#">Services</a>
           </li>
           <li class="nav-item">
             <a class="nav-link nav-head" href="#">Contacts</a>
           </li>
 ...
 <main>
     <section class="main-sectinon-1">
         <!-- start of Card -->
         <img src="../img/doctor1.png" class="rounded float-end" style="margin-right: 30%;">
         <div class="container py-3"></div>
         <div class="container py-5">
           <div class="col-md-5">
             
             <div class="h-100 p-5 border bg-light rounded-3 medical-services">
               <img src="../img/medical_services.png" alt="" width="400">
               
               <div style="text-align: justify;">
                   <h4>Lorem ipsum dolor sit amet consectetur adipisicin </h4>
                   <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Maxime recusandae voluptatem quas repellendus omnis magnam ea qui, mollitia dolorum ratione voluptatum aliquid impedit earum obcaecati modi consequatur unde blanditiis ut.</p>
               </div>
         ...
         <!-- End of Card -->
</div>  <!--Dont delete this div because it holds the whole image, main div for navbar and section 1-->
       <div class="container px-4 py-5" id="custom-cards">
         ...
         <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
             ...
             <div class="col">
               <div class="card card-cover h-100 overflow-hidden text-white bg-primary rounded-5 shadow-lg">
                 <div class="d-flex flex-column h-75 p-3 pb-1 text-shadow-1">
                   <img class="main-section-2__feature--img" src="../img/icon1.png" alt="" width=30%;>
           ...
           <div class="col">
             <div class="card card-cover h-100 overflow-hidden text-white bg-primary rounded-5 shadow-lg">
               <div class="d-flex flex-column h-50 p-3 pb-1 text-shadow-1">
                 <img class="main-section-2__feature--img" src="../img/icon2.png" alt="" width=30%;>
                 <h4 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">Lorem Ipsum</h4>
                 <h6>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas sit amet varius magna, nec fermentum nisl. Integer eu s</h6>
                 <ul class="d-flex list-unstyled mt-auto">
                   <li class="me-auto">
           ...
           <div class="col">
             <div class="card card-cover h-100 overflow-hidden text-white bg-primary rounded-5 shadow-lg">
               <div class="d-flex flex-column h-50 p-3 pb-1 text-shadow-1">
                 <img class="main-section-2__feature--img" src="../img/icon3.png" alt="" width=30%;>
                 <h4 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">Lorem Ipsum</h4>
                 <h6>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas sit amet varius magna, nec fermentum nisl. Integer eu s</h6>
                 <ul class="d-flex list-unstyled mt-auto">
                   <li class="me-auto">
     ...
     <section class="main-section-3">
         <div class="main-section-3__abt-us-cont">
             ...
             <ul class="main-section-3__list">
                 <li class="main-section-3__list-item"><img class="main-section-3__checkmark" src="../img/blue-checkmark.png" alt="">Neurologist</li>
                 <li class="main-section-3__list-item"><img class="main-section-3__checkmark" src="../img/blue-checkmark.png" alt="">Pediatrician</li>
                 <li class="main-section-3__list-item"><img class="main-section-3__checkmark" src="../img/blue-checkmark.png" alt="">Orthopedics</li>  
                 <li class="main-section-3__list-item"><img class="main-section-3__checkmark" src="../img/blue-checkmark.png" alt="">Dentist</li>
                 <li class="main-section-3__list-item"><img class="main-section-3__checkmark" src="../img/blue-checkmark.png" alt="">Nephrologist</li>
                 <li class="main-section-3__list-item"><img class="main-section-3__checkmark" src="../img/blue-checkmark.png" alt="">Cardiologist</li>
                 <li class="main-section-3__list-item"><img class="main-section-3__checkmark" src="../img/blue-checkmark.png" alt="">Dermatologist</li>
             </ul>
             <a class="main-section-3__read-more" href="">Read More</a>
         </div>
         
       <div class="main-section-3__img-cont">
             <img class="main-section-3__img" src="../img/doctor2.png" alt="">
       </div>
     </section>

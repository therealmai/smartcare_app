...
if (isset($_POST['submit'])) {
    ...
    if (file_exists($targetFileHealth)) {
        $_SESSION['reg_err']['fileExist'] = "Sorry, file already exists.";
    }
    if (file_exists($targetFileSSN)) {
        $_SESSION['reg_err']['fileExist1'] = "Sorry, file already exists.";
    }
